...
ticketmaster = Organisation.new(name: "Ticket Master", location: "London")
ticketmaster.user = maria
ticketmaster.save
puts "created ticketmaster"

smilecomedy = Organisation.new(name: "Smile Comedy", location: "London")
smilecomedy.user = lucy
smilecomedy.save!

puts "created Smile Comedy"

theatretoday = Organisation.new(name: "Theatre Today", location: "London")
theatretoday.user = maria
theatretoday.save!

puts "created theatretoday"

gigscentral = Organisation.new(name: "Gigs Central", location: "London")
...
10.times do
  experience = Experience.new(name: "Le Miserable", category:"Arts, Theatre & Shows", description: "Jean Valjean, a prisoner, breaks parole in order to start life anew. He soon becomes the caretaker of a young girl but his past comes back to catch up with him.", location: "London", date: "2020-03-03", start_time: "2020-03-03 21:25:00", end_time: "2020-03-03 21:25:00", venue_name: "Royal Theare", price_cents: 4000)
